            ...
            <div id="reservationModal" class="hidden fixed inset-0 bg-gray-800 bg-opacity-50 flex justify-center items-center z-50">
                <div class="bg-white p-6 rounded-lg shadow-lg max-w-md w-full">
                    ...
                    <div class="flex flex-col gap-4">
                        ...
                        <button id="optionBoth" class="bg-purple-500 hover:bg-purple-600 text-white px-4 py-2 rounded-md">
                            Ambas
                        </button>
                    </div>
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        optionBoth.addEventListener('click', () => {
            window.location.href = '/reserva-ambas'; 
        });
    });
        //TEST
