...
<body class="bg-gray-100 text-gray-800">
    ...
    <div class="container mx-auto mt-10 text-center">
        ...
        <div class="bg-gradient-to-r from-blue-500 to-blue-400 text-white p-8 rounded-lg shadow-md">
            <h1 class="text-4xl font-bold mb-2">Bienvenido, Corporativo</h1>
        ...
        <div class="mt-8 space-y-4 md:space-y-0 md:flex md:space-x-6 justify-center">
            <!-- Editar Perfil -->
            <a href="/editarPerfilCorp" class="bg-blue-500 hover:bg-blue-600 text-white px-6 py-3 rounded-lg shadow flex items-center justify-center">
        ...
        <div class="mt-8 space-y-4 md:space-y-0 md:flex md:space-x-6 justify-center">
            <!-- Editar Perfil -->
            <a href="/comisionesCorp" class="bg-blue-500 hover:bg-blue-600 text-white px-6 py-3 rounded-lg shadow flex items-center justify-center">
